import { StyleSheet, TextInput, Text, View, ScrollView, SafeAreaView, TouchableOpacity } from 'react-native'
...
const PasswordSchema = Yup.object().shape({
  passwordLength: Yup.number().min(4, 'Should be at least 4 characters').max(16, 'Should be at most 16 characters').required('Length is Required'),
})
